...
- **Computation.** I anchor these methods in mathematical theory — drawing on classical asymptotic analysis and random geometric graph models (e.g., nearest-neighbor constructions) — to deliver procedures that remain scalable and provably reliable at the data sizes genomics demands.
